...
\begin{todo}
& zmínit $=_\beta$ a $\twoheadrightarrow_\beta$ 
jestli se k tomu někde dál v textu odkazuju
\end{todo}
...
The corresponding grammar rule can be summarized as follows.
...
\begin{todo}
   & asi ocitovat toho van Wijngaarden [1981] s těma 2-level grammar
...
%"Barendregt-like"
\section{Inference and grammar rules producing terms in Long normal form}
\label{barlike}
