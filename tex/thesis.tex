...
Then corresponding \textit{typed \sexprTree} $TT_S[t]$ for typed \lterm is 
...
\begin{todo}
 & co to znamená mít lnf
 & potřebuju eště nějaký \textbf{propositions} z tyhle knihy?
...
\begin{todo}
 & zmínit že podobně jako mužeme transformovat inference rules
