...
\begin{todo}
 & Ten poslední odstavec je napsanej divně, přepsat.
   && říct v něm že na to budem teda používat A*. 
\end{todo}
...
\begin{todo}
& Mužem nás zajímat buď cesta nebo jen cílovej stav, nás bude zajímat
  cílovej stav - proto nebudem zaznamenávat cestu.
& víc to tu rozepsat hlavně zmínit heuristiku 
...
\begin{todo}
& náš stavovej prostor je strom takže 
  && vime že $next \not\in open \wedge next \not\in closed$
  && a tedy ani nepotřebujeme udržovat množinu closed
& dist(state,next) = 1 
\end{todo}
...
\Pseudokod{Our-A*( start , isGoal , heuristic )}{	
