...
\begin{definition}
A statement $M : \sigma$ is \textit{derivable from}
a context $\Gamma$ if it can be produced by the following rules.
\begin{align*}
...
We construct valid statements of the form \GMS 
...
\begin{todo}
   & tady to nějak okomentovat že to je teda vono
